...
for sig in sigmas:
	...
	#writes to a file
	with open('20_sep_bin_results_proxima_{}_{}.csv'.format(sig, bins_width), 'wt') as f:
	...
	with open('20_sep_scaled_results_proxima_{}_{}.csv'.format(sig, bins_width), 'wt') as f:
		csv_writer = csv.writer(f, delimiter=" ")
...
name2 = '20_sep_tabulated_results_proxima.csv'
